...
class ExampleApp(QtWidgets.QMainWindow, HomeCheck_ui.Ui_MainWindow):
    ...
    def create_check(self):
        ...
        page_4 = self.input_file(self.main_folder, self.check[3], 3)
        page_5 = self.input_file(self.main_folder, self.check[4], 4)
        page_6 = self.input_file(self.main_folder, self.check[5], 5)
        page_7 = self.input_file(self.main_folder, self.check[6], 6)
        ...
        if self.p[0] == 1:
            ...
            zero_page = PageObject.create_blank_page(None, self.list_x, self.list_y)
        ...
        if self.p[1] == 1:
            ...
            page_02 = zero_page
            page_02 = trXY_def(page_02, smesh_x, self.list_y-check_size_y-smesh_y)
            smesh_x += 310
        else:
            page_02 = PageObject.create_blank_page(None, self.list_x, self.list_y)
        ...
        if self.p[2] == 1:
            ...
            page_03 = zero_page
            page_03 = trXY_def(page_03, smesh_x, self.list_y-check_size_y-smesh_y)
            smesh_x += 620
        else:
            page_03 = PageObject.create_blank_page(None, self.list_x, self.list_y)
        ...
        if self.p[3] == 1:
            ...
            page_04 = zero_page
            page_04 = trXY_def(page_04, smesh_x, self.list_y-check_size_y-smesh_y)
            smesh_x += 310
        else:
            page_04 = PageObject.create_blank_page(None, self.list_x, self.list_y)
        ...
        if self.p[5] == 1:
            ...
            page_06 = zero_page
            page_06 = trXY_def(page_06, smesh_x, self.list_y-check_size_y-smesh_y)
            smesh_x += 310
        else:
            page_06 = PageObject.create_blank_page(None, self.list_x, self.list_y)
        ...
        if self.p[6] == 1:
            ...
            page_07 = zero_page
            page_07 = trXY_def(page_07, smesh_x, self.list_y-check_size_y-smesh_y)
            smesh_x += 310
        else:
            page_07 = PageObject.create_blank_page(None, self.list_x, self.list_y)
        ...
        for z in range(5):
            if self.p[z] == 1:
                if z == 2:
                    smesh_x += 33
                list_canvas_O.drawString(canvas_otstup_x + float(smesh_x), canvas_otstup_y, self.pk[z])  # Добавляем текст на страницу
                count += 1
                if z == 2:
        ...
        for zt in range(3, 6):    
            if self.p[zt+2] == 1:
                list_canvas_T.drawString(canvas_otstup_x + float(smesh_x), canvas_otstup_y, self.pk[zt+2])  # Добавляем текст на страницу
                smesh_x += shag_canvas
                count += 1
        ...
        print("Report  File:" + self.report_folder + self.date + "_O.pdf - created!")
